...
void blinkIndicator(void){
    ...
    WS2812::blink(0, 255, 0, 255);
    WS2812::blink(1, 255, 0, 255);
    WS2812::blink(2, 255, 0, 255);
    WS2812::blink(3, 255, 0, 255);
    WS2812::blink(4, 255, 0, 255);
    WS2812::blink(5, 255, 0, 255);
    WS2812::blink(6, 255, 0, 255);
    WS2812::blink(7, 255, 0, 255);
    WS2812::blink(8, 255, 0, 255);
    WS2812::blink(9, 255, 0, 255);
}
}